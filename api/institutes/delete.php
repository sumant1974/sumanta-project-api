...
if(
    ...
    echo json_encode(array("message" => "Institute Details Deleted Successfully","status"=>"1"));
}
...
// message if unable to create user
    ...
    echo json_encode(array("message" => "Unable to Delete institute. ".$inst->errmsg,"status"=>"0"));
}
}
else
{
