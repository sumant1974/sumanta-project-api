...
if(
    ...
    echo json_encode(array("message" => "Spoc Details Updated Successfully","status"=>"1"));
}
...
// message if unable to create user
    ...
    echo json_encode(array("message" => "Unable to Update Spoc. ".$ispoc->errmsg,"status"=>"0"));
}
}
else
{
