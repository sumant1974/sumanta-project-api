...
if(
    ...
    echo json_encode(array("message" => "Spoc Details Deleted Successfully","status"=>"1"));
}
...
// message if unable to create user
    ...
    echo json_encode(array("message" => "Unable to Delete Spoc. ".$ispoc->errmsg,"status"=>"0"));
}
}
else
{
